...
> = {
  openai: {
    category: "AI Lab",
    summary:
      "Pioneering artificial general intelligence and state-of-the-art LLM research.",
    realScore: 97,
    realStars: 520000,
    realForks: 85000,
    realRepos: 89,
  ...
  huggingface: {
    category: "AI Lab",
    summary:
      "Democratizing AI through open-source models, datasets, and ML tools.",
    realScore: 96,
    realStars: 380000,
    realForks: 64000,
    realRepos: 180,
  ...
  mistralai: {
    category: "AI Lab",
    summary: "Pushing the boundaries of open-weight foundational AI models.",
    realScore: 94,
    realStars: 95000,
    realForks: 14000,
    realRepos: 32,
  ...
  microsoft: {
    category: "Big Tech",
    summary:
      "Building developer ecosystems through VS Code, TypeScript, Azure and AI tools.",
    realScore: 98,
    realStars: 3200000,
    realForks: 850000,
    realRepos: 5120,
  ...
  google: {
    category: "Big Tech",
    summary: "Leading AI, cloud infrastructure and large scale engineering.",
    realScore: 99,
    realStars: 3500000,
    realForks: 920000,
    realRepos: 2450,
  ...
  facebook: {
    category: "Big Tech",
    summary: "Driving open-source innovation in React, PyTorch, and Llama AI.",
    realScore: 98,
    realStars: 2800000,
    realForks: 780000,
    realRepos: 1250,
  ...
  aws: {
    category: "Big Tech",
    summary:
      "Powering global cloud infrastructure and scalable backend systems.",
    realScore: 94,
    realStars: 450000,
    realForks: 125000,
    realRepos: 950,
  ...
  apple: {
    category: "Big Tech",
    summary:
      "Advancing consumer hardware, Swift ecosystems, and privacy engineering.",
    realScore: 96,
    realStars: 680000,
    realForks: 150000,
    realRepos: 820,
  ...
  netflix: {
    category: "Big Tech",
    summary:
      "Pioneering chaos engineering, microservices, and massive data streaming.",
    realScore: 95,
    realStars: 250000,
    realForks: 65000,
    realRepos: 410,
  ...
  uber: {
    category: "Big Tech",
    summary:
      "Scaling real-time dispatch, geospatial intelligence, and platform engineering.",
    realScore: 94,
    realStars: 180000,
    realForks: 48000,
    realRepos: 380,
  ...
  airbnb: {
    category: "Big Tech",
    summary: "Defining modern web architecture, data visualization, and UI/UX.",
    realScore: 93,
    realStars: 195000,
    realForks: 38000,
    realRepos: 220,
  ...
  shopify: {
    category: "Big Tech",
    summary:
      "Scaling global commerce platforms and advanced Ruby on Rails engineering.",
    realScore: 93,
    realStars: 140000,
    realForks: 28000,
    realRepos: 195,
  ...
  github: {
    ...
    summary:
      "The home for all developers, building the core tools of software collaboration.",
    realScore: 97,
    realStars: 450000,
    realForks: 92000,
    realRepos: 480,
  ...
  docker: {
    category: "Developer Tools",
    summary:
      "Standardizing software packaging and containerized deployment workflows.",
    realScore: 96,
    realStars: 380000,
    realForks: 85000,
    realRepos: 310,
  ...
  vercel: {
    category: "Developer Tools",
    summary:
      "Revolutionizing frontend development with Next.js and edge infrastructure.",
    realScore: 97,
    realStars: 520000,
    realForks: 68000,
    realRepos: 185,
  ...
  supabase: {
    category: "Developer Tools",
    summary:
      "Building the open-source Firebase alternative with powerful Postgres features.",
    realScore: 95,
    realStars: 195000,
    realForks: 18000,
    realRepos: 140,
  ...
  mongodb: {
    category: "Developer Tools",
    summary:
      "Empowering developers with scalable, document-oriented database systems.",
    realScore: 94,
    realStars: 165000,
    realForks: 42000,
    realRepos: 275,
  ...
  postmanlabs: {
    category: "Developer Tools",
    summary:
      "Simplifying API development, testing, and collaboration at scale.",
    realScore: 92,
    realStars: 85000,
    realForks: 15000,
    realRepos: 95,
  ...
  jetbrains: {
    category: "Developer Tools",
    summary:
      "Creating essential IDEs and the Kotlin language for professional developers.",
    realScore: 96,
    realStars: 280000,
    realForks: 52000,
    realRepos: 410,
  ...
  hashicorp: {
    category: "Developer Tools",
    summary:
      "Automating cloud infrastructure through Terraform and modern DevSecOps.",
    realScore: 95,
    realStars: 310000,
    realForks: 78000,
    realRepos: 240,
  ...
  cloudflare: {
    ...
    summary:
      "Building a better, faster, and more secure global internet edge network.",
    realScore: 95,
    realStars: 240000,
    realForks: 42000,
    realRepos: 350,
  ...
  nvidia: {
    category: "Infrastructure",
    summary: "Accelerating the future of AI computing and graphics processing.",
    realScore: 96,
    realStars: 320000,
    realForks: 95000,
    realRepos: 510,
  ...
  intel: {
    category: "Infrastructure",
    summary:
      "Engineering the foundational silicon and architecture of global computing.",
    realScore: 92,
    realStars: 180000,
    realForks: 55000,
    realRepos: 620,
  ...
  amd: {
    category: "Infrastructure",
    summary:
      "Pushing the limits of high-performance computing and graphics processing.",
    realScore: 91,
    realStars: 120000,
    realForks: 32000,
    realRepos: 280,
  ...
  handler: async (ctx) => {
    ...
    const companies = Array.from(companiesMap.values())
      ...
      .map((c) => {
        ...
        const sortedRepos = [...c.repos].sort(
  ...
  handler: async (ctx, args) => {
    ...
    if (!repos || repos.length === 0) {
      ...
      const filtered = allRepos.filter(
        (r) => r.owner?.toLowerCase() === args.owner.toLowerCase(),
      );
    ...
    if (eliteMeta) {
      ...
      activeProjectsDisplay = Math.max(
        activeProjects,
        Math.floor(eliteMeta.realRepos * 0.15),
      );
    } else {
    ...
    const topLang =
      ...
      "multiple languages";
    const topTopic =
      Array.from(topicCounts.entries()).sort((a, b) => b[1] - a[1])[0]?.[0] ||
      "software";
