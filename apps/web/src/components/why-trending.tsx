      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <div className="flex justify-between items-end mb-2">
            <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Star Velocity</span>
            <span className="text-xs font-mono text-emerald-600 dark:text-emerald-400">+1,204 this week</span>
          </div>
        ...
        <div>
          <div className="flex justify-between items-end mb-2">
            <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Release Activity</span>
            <span className="text-xs font-mono text-slate-500">v2.1 just dropped</span>
          </div>
          <div className="pt-2">
