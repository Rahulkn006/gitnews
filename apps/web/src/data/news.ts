...
export const mockNews: NewsItem[] = [
  {
    ...
    impactScore: 98,
    explanation:
      "The React team has merged the initial experimental version of the React Compiler, promising significant performance improvements without manual memoization.",
  ...
  },
  {
    ...
    impactScore: 92,
    explanation:
      "Vercel released the first release candidate for Next.js 14.2, featuring improved Turbopack stability and caching updates.",
  ...
  },
  {
    ...
    impactScore: 100,
    explanation:
      "A high-severity vulnerability was patched in a popular networking library. Developers are urged to update immediately.",
  ...
  },
  {
    ...
    impactScore: 95,
    explanation:
      "LangChain continues its explosive growth as developers flock to build autonomous AI agents with the new v0.1 release.",
  ...
  },
  {
    ...
    impactScore: 88,
    explanation:
      "Oxc, a new JavaScript toolchain written in Rust, claims to be 50x faster than ESLint in early benchmarks.",
  ...
  },
  {
    ...
    impactScore: 94,
    explanation:
      "TypeScript 5.4 is officially released, bringing the NoInfer utility type, improved type narrowing, and better performance.",
  ...
  },
  {
    ...
    impactScore: 85,
    explanation:
      "Upcoming changes to module resolution in Node.js 22 may require package authors to update their export maps.",
  ...
  },
  {
    ...
    impactScore: 90,
    explanation:
      "Vite 5.2 brings significant performance improvements to the development server startup time and HMR.",
  ...
  },
  {
    ...
    impactScore: 97,
    explanation:
      "A new open-weights model has been released that achieves state-of-the-art performance on popular coding benchmarks.",
  ...
  },
  {
    ...
    impactScore: 82,
    explanation:
      "The Deno standard library has officially been stabilized and reached version 1.0 after years of development.",
