...
const RepoBattleComponent = () => {
  ...
  const runBattle = async () => {
    ...
    try {
      ...
      setError(
        e.message || "Failed to analyze battle. Insufficient data or AI error.",
      );
    } finally {
      setIsBattling(false);
    }
    ...
    <main className="max-w-6xl mx-auto px-4 md:px-8 py-12">
      ...
      <div className="mb-12 text-center max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground text-sm font-mono">
          Compare open-source projects using deep developer intelligence and AI
          synthesis.
        </p>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl p-6 md:p-8 mb-12 shadow-sm relative overflow-visible">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 border-t border-border/50 pt-8">
          <div className="flex flex-wrap justify-center gap-2">
            ...
            <button
              onClick={() =>
                handleQuickCompare("facebook", "react", "vuejs", "vue")
              }
              className="text-[10px] px-2 py-1 bg-muted rounded hover:bg-stone-200 dark:hover:bg-stone-800 transition font-mono border border-border"
            >
              React vs Vue
            </button>
            <button
              onClick={() =>
                handleQuickCompare("vercel", "next.js", "nuxt", "nuxt")
              }
              className="text-[10px] px-2 py-1 bg-muted rounded hover:bg-stone-200 dark:hover:bg-stone-800 transition font-mono border border-border"
            >
              Next vs Nuxt
            ...
            <button
              onClick={() =>
                handleQuickCompare("docker", "docker", "containers", "podman")
              }
              className="text-[10px] px-2 py-1 bg-muted rounded hover:bg-stone-200 dark:hover:bg-stone-800 transition font-mono border border-border"
            >
              Docker vs Podman
      ...
      {isBattling && (
        <div className="py-24 flex flex-col items-center justify-center">
          ...
          <p className="font-mono text-sm animate-pulse text-muted-foreground">
            Olla AI is analyzing GitHub metrics, growth velocity, and community
            discussions...
          </p>
        </div>
      )}
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-12">
          ...
          <div className="bg-gradient-to-br from-stone-900 to-stone-950 dark:from-stone-900 dark:to-black border border-stone-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              <span className="text-[10px] font-mono text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mb-2 font-bold">
                WINNER
              </span>
          ...
          <div className="max-w-3xl mx-auto">
            <h3 className="font-mono text-sm font-bold uppercase tracking-widest text-muted-foreground border-b border-border pb-2 mb-6">
              Winning Reasons
            </h3>
            <div className="grid gap-3">
              {battleResult.synthesis.winningReasons.map(
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="text-xl font-bold font-serif mb-6 text-foreground">
                  {battleResult.repoA.name}
                </h4>
                <div className="space-y-6">
                  <div>
                    ...
                    <ul className="space-y-2">
                      {battleResult.synthesis.strengthsA.map(
                        (s: string, i: number) => (
                          <li
                            key={i}
                  ...
                  <div>
                    <span className="text-[10px] font-mono text-red-400 uppercase tracking-widest block mb-3">
                      Weaknesses
                    </span>
                    <ul className="space-y-2">
                      {battleResult.synthesis.weaknessesA.map(
                        (w: string, i: number) => (
                          <li
                            key={i}
                            className="flex items-start gap-2 text-sm font-mono"
              ...
              <div className="bg-card border border-border rounded-xl p-6">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <ul className="space-y-2">
                      {battleResult.synthesis.strengthsB.map(
                        (s: string, i: number) => (
                          <li
                            key={i}
                            className="flex items-start gap-2 text-sm font-mono"
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {battleResult.synthesis.weaknessesB.map(
                        (w: string, i: number) => (
                          <li
                            key={i}
                            className="flex items-start gap-2 text-sm font-mono"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-6">
                <h4 className="text-sm font-bold font-mono text-foreground mb-4">
                  Choose {battleResult.repoA.name} if you need:
                </h4>
                <ul className="space-y-3">
                  {battleResult.synthesis.useCasesA.map(
                    (uc: string, i: number) => (
                      <li
                        key={i}
              ...
              <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-6">
                <h4 className="text-sm font-bold font-mono text-foreground mb-4">
                  Choose {battleResult.repoB.name} if you need:
                </h4>
                <ul className="space-y-3">
                  {battleResult.synthesis.useCasesB.map(
                    (uc: string, i: number) => (
                      <li
                        key={i}
                        className="flex items-start gap-3 text-sm font-serif"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-3xl font-black font-serif text-emerald-600 dark:text-emerald-400">
                    {battleResult.repoA.finalScore}
                ...
                <ScoreBar
                  ...
                  score={
                    battleResult.synthesis.learningScoresA.beginnerFriendly
                  }
                />
                <ScoreBar
                  label="Documentation"
                  score={battleResult.synthesis.learningScoresA.documentation}
                />
                <ScoreBar
                  label="Job Demand"
                  score={battleResult.synthesis.learningScoresA.jobDemand}
                />
                <ScoreBar
                  label="Future Potential"
                  score={battleResult.synthesis.learningScoresA.futurePotential}
                />
              </div>
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-4">
                ...
                <ScoreBar
                  label="Beginner Friendly"
                  score={
                    battleResult.synthesis.learningScoresB.beginnerFriendly
                  }
                />
                <ScoreBar
                  label="Documentation"
                  score={battleResult.synthesis.learningScoresB.documentation}
                />
                <ScoreBar
                  label="Job Demand"
                  score={battleResult.synthesis.learningScoresB.jobDemand}
                />
                <ScoreBar
                  label="Future Potential"
                  score={battleResult.synthesis.learningScoresB.futurePotential}
                />
              </div>
            </div>
          </div>
          ...
          <div className="pt-8">
            ...
            <div className="space-y-4">
              <MetricRow
                title="Total Stars"
                repoA={battleResult.repoA.name}
                repoB={battleResult.repoB.name}
                a={battleResult.repoA.stars?.toLocaleString()}
                b={battleResult.repoB.stars?.toLocaleString()}
              />
              <MetricRow
                title="Total Forks"
                repoA={battleResult.repoA.name}
                repoB={battleResult.repoB.name}
                a={battleResult.repoA.forks?.toLocaleString()}
                b={battleResult.repoB.forks?.toLocaleString()}
              />
              <MetricRow
                title="Open Issues"
                repoA={battleResult.repoA.name}
                repoB={battleResult.repoB.name}
                a={
                  battleResult.repoA.githubData?.open_issues_count?.toLocaleString() ||
                  "N/A"
                }
                b={
                  battleResult.repoB.githubData?.open_issues_count?.toLocaleString() ||
                  "N/A"
                }
              />
              <MetricRow
                ...
                repoB={battleResult.repoB.name}
                a={
                  battleResult.repoA.githubData?.pushed_at
                    ? new Date(
                        battleResult.repoA.githubData.pushed_at,
                      ).toLocaleDateString()
                    : "N/A"
                ...
                b={
                  battleResult.repoB.githubData?.pushed_at
                    ? new Date(
                        battleResult.repoB.githubData.pushed_at,
                      ).toLocaleDateString()
                    : "N/A"
              ...
              <MetricRow
                ...
                repoA={battleResult.repoA.name}
                repoB={battleResult.repoB.name}
                a={`+${battleResult.repoA.growth7d || 0}`}
                b={`+${battleResult.repoB.growth7d || 0}`}
              />
              <MetricRow
                title="Language"
                repoA={battleResult.repoA.name}
                repoB={battleResult.repoB.name}
                a={battleResult.repoA.language || "N/A"}
                b={battleResult.repoB.language || "N/A"}
              />
            </div>
          </div>
        </div>
...
function MetricRow({
  ...
  a,
  b,
}: { title: string; repoA: string; repoB: string; a: string; b: string }) {
  return (
    <div className="flex flex-col items-center bg-card border border-border rounded-lg p-4 text-sm font-mono">
      ...
      <div className="w-full flex justify-between items-center px-4">
        <div className="flex flex-col items-start w-1/2">
          <div
            className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold mb-1 truncate max-w-[120px]"
            title={repoA}
          >
            {repoA}
          </div>
