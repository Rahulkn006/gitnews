      ...
      <div className="grid grid-cols-1 lg:grid-cols-9 gap-12">
        ...
        <div className="lg:col-span-4 flex flex-col gap-10">
          ...
          {featuredStories.length === 0 && (
            <p className="text-stone-500 font-serif italic">No featured stories in this category.</p>
          )}
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <div className="flex items-center gap-2 text-xs font-mono font-bold uppercase tracking-widest text-slate-500 mb-3">
                    <span className="text-stone-900 dark:text-stone-300">{story.source}</span>
        ...
        <div className="lg:col-span-5 flex flex-col gap-8">
          ...
          {latestStories.length === 0 && (
            <p className="text-stone-500 font-serif italic">No more stories in this category.</p>
          )}
