...
export function RepoArticlePage({
  ...
  const story = news.find(
    (n: any) =>
      n.repository?.toLowerCase() === `${owner}/${name}`.toLowerCase(),
  );
  ...
  const repo = {
    ...
    description:
      story?.explanation ||
      "A high-velocity open source repository generating massive community interest.",
    ...
    <div className="w-full min-h-screen bg-white text-slate-900 dark:bg-[#0a0a0a] dark:text-slate-200 font-sans">
      ...
      <div className="px-4 md:px-8 pt-8">
        <nav className="max-w-[1200px] mx-auto flex items-center justify-between mb-8 pb-4 border-b border-stone-200 dark:border-stone-800">
          <a
            href="/"
            className="font-serif text-2xl font-black tracking-tighter text-slate-900 dark:text-white hover:text-emerald-600 transition-colors"
          >
            ← GitNews
          </a>
            ...
            <img
              ...
              onError={(e) => {
                ...
                (e.target as HTMLImageElement).className =
                  "w-full h-full object-contain p-10 opacity-50";
              }}
            />
          </div>
        </header>
          ...
          <div className="lg:col-span-8 flex flex-col gap-10">
            <section>
              ...
              <p className="text-lg leading-relaxed text-slate-700 dark:text-slate-300 font-serif">
                {repo.description} This project has recently seen a massive
                surge in developer interest, breaking into the top trending
                repositories across GitHub. Open source contributors are
                flocking to its issues and pull requests, indicating strong
            ...
            <section>
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800 p-6 rounded-xl text-emerald-900 dark:text-emerald-100 font-serif leading-relaxed">
                Based on our analysis of recent commits, pull requests, and
                community discussions, {repo.name} is solving a critical pain
                point in modern development. The recent architecture changes
                have improved performance by 40%, and the introduction of a new
                plugin system has galvanized the community to build extensions.
              </div>
            </section>
          </div>
            ...
            <div className="border border-stone-200 dark:border-stone-800 rounded-xl p-5 bg-stone-50 dark:bg-[#111]">
              ...
              <div className="flex flex-col gap-4 mt-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-700 dark:text-slate-300 font-medium">
                    Security patch for core module
                  </div>
                </div>
              </div>
            </div>
