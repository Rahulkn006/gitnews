  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <MarketSection
        ...
        repos={topGainers}
        type="gain"
        icon={<CaretUp className="w-4 h-4 text-emerald-500" weight="fill" />}
      />
      <MarketSection
        title="Fast Movers"
        repos={fastMovers}
      ...
      <MarketSection
        ...
        type="launch"
        icon={
          <RocketLaunch className="w-4 h-4 text-purple-500" weight="fill" />
        }
      />
    </div>
  );
...
function MarketSection({
  ...
  type,
  icon,
}: { title: string; repos: any[]; type: string; icon: React.ReactNode }) {
