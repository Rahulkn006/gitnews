...
exports.ollagraph = exports.OllagraphClient = void 0;
const github_service_1 = require("../github.service");
const ollima_service_1 = require("./ollima.service");
...
class OllagraphClient {
    async analyzeRepository(owner, repo) {
        ...
        try {
            ...
            const [repoData, readme, tree, pkgJsonStr] = await Promise.all([
                github_service_1.GitHubService.fetchGitHubAPI(`/repos/${owner}/${repo}`),
                github_service_1.GitHubService.fetchReadme(owner, repo),
                github_service_1.GitHubService.fetchRepoTree(owner, repo),
                github_service_1.GitHubService.fetchRepoFile(owner, repo, "package.json").catch(() => null),
            ]);
            if (!repoData) {
            ...
            if (tree && Array.isArray(tree)) {
                tree
                    ...
                    if (t.path === "src")
                        ...
                        folderStructure[t.path] = "Module directory";
                });
            }
            ...
            const ollimaIntel = await ollima_service_1.ollima.generateIntelligence(repoData, owner, repo);
            ...
            const analysis = {
                ...
                bestUseCases: ollimaIntel.useCases.join(" • ") ||
                ...
                alternatives: ollimaIntel.alternatives.join(" • ") ||
                    `Other open source tools in the domain.`,
                verdict: ollimaIntel.limitations.length > 0
    ...
    async generateDeepResearch(repoData, owner, repo) {
...
exports.OllagraphClient = OllagraphClient;
exports.ollagraph = new OllagraphClient();
//# sourceMappingURL=ollagraph.service.js.map